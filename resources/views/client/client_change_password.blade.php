                                                ...
                                                <div class="d-flex align-items-start mt-3 mt-sm-0">
                                                    <div class="flex-shrink-0">
                                                        <div class="avatar-xl me-3">
                                                            <img src="{{ (!empty($profileData->photo)) ? url('upload/client_images/' .$profileData->photo) : url('upload/poto_filmBagus.jpg')}}" alt="" class="img-fluid rounded-circle d-block">
                                                        </div>
                                                    </div>
            ...
            <div class="col-lg-6">
                <div>
                    ...
                    <div class="mb-3">
                        ...
                        <input class="form-control @error('old_password') is-invalid @enderror " name="new_password" type="password" id="new_password">
                        @error('new_password')
                        <span class="text-danger">{{ $message }}</span>
                        @enderror
                    </div>
