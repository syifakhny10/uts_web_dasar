...
<html lang="en">
                                ...
                                <div class="d-flex flex-column h-100">
                                    ...
                                    <div class="auth-content my-auto">
                                        <div class="text-center">
                                            <h5 class="mb-0">Welcome Client Register</h5>
    ...
    <form class="mt-4 pt-2" action="{{ route('client.register.submit') }}" method="post">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="phone" class="form-control" id="email" placeholder="Enter Email" required>
                                        </div>
                                        <div class="mb-3">
                                            <label class="form-label">Address</label>
                                            <input type="text" name="address" class="form-control" id="email" placeholder="Enter Email" required>
                                        </div>
                                        <div class="mb-3">
